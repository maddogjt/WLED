...
`;
    ...
    let buf = fs.readFileSync(srcDir + "/" + s.file);
    if (s.compress) {
      buf = zlib.gzipSync(buf, { level: zlib.constants.Z_BEST_COMPRESSION });
    }
...
writeChunks(
  ...
  [
    {
      file: "index.html",
      name: "PAGE_new_index_html",
      method: "binary",
      compress: true,
    },
    {
      file: "index.bundle.js",
      name: "PAGE_new_index_bundle_js",
      method: "binary",
      compress: true,
    },
    {
      file: "index.css",
      name: "PAGE_new_index_css",
      method: "binary",
      compress: true,
    },
  ],
  "wled00/html_new_ui.h"
);
