...
export function SettingsDmx(): JSX.Element {
  return (
    <form method="post" class="settings">
      ...
      Proxy Universe <input name="PU" type="number" min="0" max="63999" required /> from E1.31 to
      DMX (0=disabled)
      <br />
      <i>This will disable the LED data output to DMX configurable below</i>
      <br />
      <br />
      <i>Number of fixtures is taken from LED config page</i>
      <br />
      Channels per fixture (15 max):{' '}
      <input type="number" min="1" max="15" name="CN" maxLength={2} /*onchange="mMap();"*/ />
      <br />
      Start channel: <input type="number" min="1" max="512" name="CS" maxLength={2} />
      <br />
      Spacing between start channels:{' '}
      <input type="number" min="1" max="512" name="CG" maxLength={2} /*onchange="mMap();"*/ /> [{' '}
      <a href="javascript:alert('if set to 10, first fixture will start at 10,\nsecond will start at 20 etc.\nRegardless of the channel count.\nMakes memorizing channel numbers easier.');">
        info
      </a>{' '}
      ]<br />
      ...
      <a href="/dmxmap">
        <button type="button">DMX Map</button>
      </a>
      <br />
